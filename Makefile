...
KCONFIG_AUTOGEN_LIST=$(OUTPUT_PATH)/Kconfig/platform.autogen
...
######################################################################
# Configuration tool
$(OUTPUT_PATH)/Kconfig/platform.autogen: FORCE
	@mkdir -p $(dir $@)
	@echo "#Autogenerated file. Do not edit" > $@
	@echo -n "#" >> $@
	@date >> $@
	@for platform in $(shell ls -d $(AUSBEE_DIR)/Platforms/*/); do \
		cat $$platform/Kconfig >> $@; \
	done
...
######################################################################
## dummy rule for autogenerated files
FORCE:
